  ...
  <header class="p-3 encabezado mb-5">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <div class="text-end">
          <a name="" id="" class="btn btn-outline-light me-2" href="<?php echo $url_base;?>secciones/citas/index.php" role="button">Agendar citas</a>
          <a name="" id="" class="btn btn-outline-light me-2" href="<?php echo $url_base;?>secciones/expediente/index.php" role="button">Ver expediente médico</a>
